...
// 주변 300m 의 개업·폐업. 위아래로 갈라 그리고 쌓지 않는다. 둘은 반대 방향의
// 흐름이라 쌓으면 «합계»라는 있지도 않은 양이 생긴다.
//
// 6개월 · 3x3 링은 실측으로 정했다. 단일 100m 칸은 어느 단위로 묶어도 구간의
// 대부분이 비지만(6개월도 75%), 3x3 링이면 20구간 중 19개가 찬다. 서버 계약과
// 함께 움직이는 값이라 화면에서 임의로 바꾸지 않는다.
