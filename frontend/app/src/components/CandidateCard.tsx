...
/**
 * 검증된 자리 / 과열 신호 배지는 뺐다. 「최근 개업 급증 = 위험」을 홀드아웃
 * (2023 코호트 n=7,915)에서 재보니 급증 상위 10% 의 3년 생존율이 60.4%
 * [56.8, 63.8] 로 나머지 57.8% [56.5, 59.0] 보다 오히려 높았고 CI 도 겹쳤다.
 * 방향이 반대이고 구분도 안 된다(model-findings §22).
 */
