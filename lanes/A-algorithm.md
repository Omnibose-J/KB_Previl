...
| | |
|---|---|
| 순수 입지 모델 | **LightGBM (현행 유지)** · AUC **0.6383** (최고 베이스라인 0.5668 · 마진 +0.0714) · seed=0 = 배포분 |
| 1등급 자리 | 실측 3년 생존율 **80.1%** (75.4–84.2) · n=317 · 전체 58.6% |
| 9등급 자리 | **10.1%** (7.2–13.9) · n=317 · 양끝 격차 70.0%p |
...
변인통제: 면적 25㎡ 미만의 1·9등급 격차 **34.9%p** ↔ 90㎡ 이상
**15.0%p** (`score_meta.observed_by_grade_area`, legacy 벤치 train 2005–2018 /
